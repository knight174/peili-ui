...
export function stylesToShortcuts<T extends Record<string, any> = Record<string, any>>(
  styles: T,
  variant: string = '',
) {
...
export function cssVarToShortcuts<T extends Record<string, any> = Record<string, any>>(
  cssVars: T,
  variant: string = '',
